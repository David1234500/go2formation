...
{   //////////////////Set logging details///////////////////////////////////////////////////////////
    ...
    hlc_communicator.onFirstTimestep([&](VehicleStateList vehicle_state_list) {
        ...
        for(auto vehicle_state:vehicle_state_list.state_list())
        {
            ...
            if(send_off_map_edge){
                ...
                target_positions.push_back(target_pbi);
                target_poses[vehicle_state.vehicle_id()] = planner.indexToPose(target_pbi);
            }
    ...
    hlc_communicator.onEachTimestep([&](VehicleStateList vehicle_state_list) {
        ...
        for(auto vehicle_state:vehicle_state_list.state_list())
        {
            ...
            TrajectoryPoint trajectory_point;
            trajectory_point.px(start_poses[vehicle_state.vehicle_id()].pos[0] / 100.f);
            trajectory_point.py(start_poses[vehicle_state.vehicle_id()].pos[1] / 100.f);
            ...
            trajectory_point2.px(target_poses[vehicle_state.vehicle_id()].pos[0] / 100.f);
            trajectory_point2.py(target_poses[vehicle_state.vehicle_id()].pos[1] / 100.f);
